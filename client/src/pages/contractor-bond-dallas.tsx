...
const bondTypes = [
  { type: "General Contractor Bond", amount: "$25,000", authority: "City of Dallas Development Services" },
  { type: "Electrical Contractor Bond", amount: "$10,000", authority: "City of Dallas Development Services" },
  { type: "HVAC / AC Contractor Bond", amount: "$10,000", authority: "City of Dallas Development Services" },
  { type: "Plumbing Contractor Bond", amount: "$10,000", authority: "City of Dallas Development Services" },
  { type: "Roofing Contractor Bond", amount: "$10,000", authority: "City of Dallas Development Services" },
  { type: "Sign Contractor Bond", amount: "$10,000", authority: "City of Dallas Development Services" },
];

const faqs = [
  {
    q: "Does Dallas require a contractor bond?",
    a: "Yes. The City of Dallas requires licensed contractors to carry a surety bond as a condition of holding a city contractor license or pulling building permits. Bond requirements vary by trade and license type, and are administered through Dallas Development Services.",
  },
  {
    q: "What is the bond amount for a general contractor in Dallas?",
    a: "General contractors in Dallas typically require a $25,000 surety bond. Trade contractors (electrical, HVAC, plumbing, roofing) typically require $10,000. Check your specific license type with Dallas Development Services for the exact requirement.",
  },
  {
  ...
  },
  {
    ...
    a: "Possibly. A TDLR license covers your state-level credentials. However, to pull permits in the City of Dallas or operate under a Dallas city license, many trades need a separate Dallas-specific surety bond in addition to their TDLR bond. We can issue both.",
  },
  {
    q: "How do I file my contractor bond with the City of Dallas?",
    a: "After purchasing your bond, you'll receive a PDF certificate. Submit it to Dallas Development Services as part of your contractor license application or renewal. Quantum Surety provides filing instructions with every bond.",
  },
];

export default function ContractorBondDallas() {
  useSEO({
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-indigo-900 via-indigo-800 to-teal-700 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-2 text-indigo-300 text-sm mb-4 flex-wrap">
            ...
            <span>Dallas Contractor Bond</span>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-14">
        ...
        {/* Bond types */}
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Dallas Contractor License Bonds by Trade</h2>
          <p className="text-gray-600 text-sm mb-6">The City of Dallas requires surety bonds for contractor licenses across multiple trades. Bond amounts are set by Dallas Development Services.</p>
        ...
        {/* Why Dallas contractors need bonds */}
        <section className="bg-indigo-50 rounded-2xl p-8 border border-indigo-100">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Why Does Dallas Require a Contractor Bond?</h2>
          <p className="text-gray-700 text-sm leading-relaxed mb-4">
            Dallas contractor bonds protect homeowners, businesses, and the City of Dallas from financial harm caused by a licensed contractor's failure to perform work, violate building codes, or abandon a project. The bond is a financial guarantee — not insurance for the contractor, but a promise backed by a licensed surety company.
          </p>
          <div className="grid sm:grid-cols-2 gap-4 mt-4">
            {[
              "Incomplete or abandoned construction projects",
              "Violations of Dallas building codes",
        ...
        {/* How to get bonded */}
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-8">Get Your Dallas Contractor Bond in 3 Steps</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { step: "1", title: "Tell us your trade", body: "Select your contractor license type and bond amount required by Dallas Development Services. Takes 2 minutes." },
              { step: "2", title: "Instant approval", body: "Most Dallas contractors are approved immediately. No financial statements required for standard bond amounts." },
              { step: "3", title: "File with Dallas", body: "Bond certificate emailed instantly as a PDF. Submit to Dallas Development Services with your license application." },
            ].map((s) => (
