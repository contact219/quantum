...
const leads = [
  ...
  { name: 'Wendy Cole',                       email: 'wwcolern@gmail.com',                           phone: '210-392-2995',  bond: 'Texas Notary Bond',             source: 'get-bond form',    time: '1:37 AM' },
  { name: 'David Richard Franks',             email: 'onefromabove@aol.com',                         phone: '191-586-7414',  bond: 'Texas Notary Bond',             source: 'get-bond form',    time: '12:08 AM' },
  { name: 'Jessyl Woods Vinning',             email: 'jawoods@ymail.com',                            phone: '817-808-6006',  bond: 'Texas Notary Bond',             source: 'get-bond form',    time: '9:54 PM*' },
  { name: 'Monica Flores',                    email: 'mflores@firstunited.net',                      phone: '806-473-8429',  bond: 'Texas Notary Bond',             source: 'get-bond form',    time: '8:53 PM*' },
  { name: 'Meloney Carroll',                  email: 'mcarroll@kemper.com',                          phone: '972-807-1296',  bond: 'Texas Notary Bond',             source: 'get-bond form',    time: '7:36 PM*' },
  { name: 'Schabandol Johnson',               email: 'banjohnson29@hotmail.com',                     phone: '504-373-7009',  bond: 'Texas Notary Bond',             source: 'get-bond form',    time: '7:12 PM*' },
  { name: 'WELDING AND SPECIALTY PIPING LLC', email: 'jzendejo@waspsvcs.com',                        phone: '832-983-3087',  bond: 'Texas Contractor License Bond', source: 'auto-pipeline',    time: '1:45 AM' },
  { name: 'ROOF PORTFOLIO MANAGEMENT, LLC',   email: 'tye@roofpm.com',                               phone: '214-454-5485',  bond: 'Texas Contractor License Bond', source: 'auto-pipeline',    time: '1:45 AM' },
];
...
<table style="width:100%;background:linear-gradient(135deg,#0a0f1e 0%,#1e3a5f 100%);border-radius:12px;margin-bottom:24px;border-collapse:collapse">
  <tr><td style="padding:24px 28px">
    ...
    <div style="color:#fff;font-size:22px;font-weight:800">Daily Leads Report</div>
    <div style="color:#94a3b8;font-size:13px;margin-top:4px">${today} &nbsp;·&nbsp; All times CDT &nbsp;·&nbsp; * = late previous evening</div>
  </td></tr>
</table>
...
<div style="background:#fff;border:1px solid #e2e8f0;border-radius:10px;overflow:hidden;margin-bottom:20px">
  <div style="padding:14px 20px;border-bottom:1px solid #e2e8f0;background:#f8fafc">
    <span style="font-size:13px;font-weight:700;color:#0f172a">All Leads Today</span>
...
async function main() {
  await ses.send(new SendEmailCommand({
    ...
    Message: {
      Subject: { Data: `Daily Leads Report — ${total} leads · ${today}`, Charset: 'UTF-8' },
