...
export default function GDNBondFortWorth() {
  useSEO({
    ...
    description: "Get your Texas GDN dealer bond in Fort Worth same-day. Required under §503.033 for all Fort Worth / DFW motor vehicle dealer licenses. $50,000 bond from $250 for the 2-year term. Instant PDF delivery.",
