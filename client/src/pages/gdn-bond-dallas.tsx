...
const faqs = [
  { q: "Do Dallas auto dealers need a GDN bond?", a: "Yes. Every licensed motor vehicle dealer in Texas — including dealers in Dallas and the DFW metroplex — must carry a $50,000 GDN surety bond under Texas Transportation Code §503.033 before TxDMV will issue or renew a dealer license." },
  { q: "How much does a GDN bond cost for a Dallas dealer?", a: "GDN dealer bonds through Quantum Surety start at $250 for the full 2-year term, which is RLI's minimum premium. RLI prices each bond, and your exact premium is confirmed before you pay." },
  { q: "How fast can I get a GDN bond in Dallas?", a: "Same-day. Apply online, get approved, and receive your bond certificate as an instant PDF — ready to submit to TxDMV's eLICENSING portal the same day." },
  { q: "Does a Dallas dealer need a city bond in addition to the GDN bond?", a: "The GDN bond is a state-level TxDMV requirement. Some Dallas-area municipalities may have additional local business license requirements, but the $50,000 GDN bond is the primary surety requirement for your dealer license." },
...
export default function GDNBondDallas() {
  useSEO({
    title: "GDN Bond Dallas TX | Texas Motor Vehicle Dealer Bond | Quantum Surety",
    description: "Get your Texas GDN dealer bond in Dallas same-day. Required under §503.033 for all DFW motor vehicle dealer licenses. $50,000 bond from $250 for the 2-year term. Instant PDF delivery.",
    canonical: "/bonds/gdn-bond-dallas",
  });
    ...
    <div className="min-h-screen bg-white">
      <section className="bg-gradient-to-br from-indigo-900 via-indigo-800 to-teal-700 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4 leading-tight">GDN Bond — Dallas, Texas Motor Vehicle Dealers</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-14">
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Dallas Dealer License Types That Require a GDN Bond</h2>
          <p className="text-gray-600 text-sm mb-6">All six TxDMV dealer license categories require a $50,000 GDN bond — whether your lot is in Dallas, Irving, Garland, Plano, or anywhere in the DFW metroplex.</p>
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Frequently Asked Questions — Dallas GDN Bond</h2>
      ...
      <div className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <div className="mt-10">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[{ href: "/bonds/gdn-bond-houston", title: "GDN Bond — Houston", tag: "Houston" }, { href: "/bonds/gdn-bond-austin", title: "GDN Bond — Austin", tag: "Austin" }, { href: "/bonds/gdn-bond-texas", title: "Texas GDN Bond Overview", tag: "Statewide" }].map((item) => (
