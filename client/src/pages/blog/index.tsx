...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    title: "TxDMV Records Show 1,777 Texas Auto Dealer Surety Bonds Past Their Expiration Date",
    description: "In a June 2026 snapshot of TxDMV records, 1,777 Texas GDN dealer records showed a surety bond past its expiration date. What that does and does not mean for car buyers.",
    date: "2026-06-24",
    readTime: "5 min read",
