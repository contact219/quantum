...
const faqs = [
  ...
  { q: "How much does a GDN bond cost for a Fort Worth dealer?", a: "Most Fort Worth dealers pay $100–$300 per year. Your exact rate is based on your personal credit score. Dealers with good credit (720+) typically pay around $100–$150/year for $50,000 in coverage." },
...
export default function GDNBondFortWorth() {
  useSEO({
    title: "GDN Bond Fort Worth TX | Texas Motor Vehicle Dealer Bond | Quantum Surety",
    description: "Get your Texas GDN dealer bond in Fort Worth same-day. Required under §503.033 for all Fort Worth / DFW motor vehicle dealer licenses. $50,000 bond from $100/yr. Instant PDF delivery.",
    canonical: "/bonds/gdn-bond-fort-worth",
  });
    ...
    <div className="min-h-screen bg-white">
      <section className="bg-gradient-to-br from-indigo-900 via-indigo-800 to-teal-700 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4 leading-tight">GDN Bond — Fort Worth / DFW Motor Vehicle Dealers</h1>
          <p className="text-indigo-100 text-lg leading-relaxed mb-8 max-w-2xl">
            Fort Worth / DFW motor vehicle dealers need a $50,000 GDN surety bond before TxDMV will issue or renew a dealer license. Get bonded same-day — instant PDF certificate, accepted by TxDMV eLICENSING.
          </p>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-14">
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Fort Worth Dealer License Types That Require a GDN Bond</h2>
          <p className="text-gray-600 text-sm mb-6">All six TxDMV dealer license categories require a $50,000 GDN bond — whether your lot is in Fort Worth, Arlington, Irving, Grand Prairie, or anywhere in the DFW metroplex.</p>
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Frequently Asked Questions — Fort Worth GDN Bond</h2>
      ...
      <div className="max-w-4xl mx-auto px-4 pb-16">
        <div className="bg-indigo-900 rounded-2xl p-8 text-white text-center">
          <h2 className="text-2xl font-bold mb-2">Get Your Fort Worth GDN Bond Today</h2>
