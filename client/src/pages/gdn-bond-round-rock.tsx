...
const FAQ_SCHEMA = {
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "Do auto dealers in Round Rock need a GDN bond?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Texas law requires all licensed motor vehicle dealers to obtain a $25,000 GDN surety bond through TxDMV as a condition of receiving or renewing a General Distinguishing Number (GDN) license." } },
    { "@type": "Question", "name": "How much does a GDN bond cost in Round Rock?", "acceptedAnswer": { "@type": "Answer", "text": "GDN dealer bond premiums start from around $100–$200 per year depending on your credit profile. Quantum Surety offers instant quotes with no obligation." } },
    { "@type": "Question", "name": "How do I get a GDN bond in Round Rock?", "acceptedAnswer": { "@type": "Answer", "text": "Apply online at Quantum Surety, receive instant approval, and get your $25,000 GDN bond certificate emailed the same day — ready to submit with your TxDMV dealer license application." } },
...
const faqs = [
  { q: "Do auto dealers in Round Rock need a GDN bond?", a: "Yes. Texas law requires all licensed motor vehicle dealers to obtain a $25,000 GDN surety bond through TxDMV as a condition of receiving or renewing a General Distinguishing Number (GDN) license." },
  { q: "How much does a GDN bond cost in Round Rock?", a: "GDN dealer bond premiums start from around $100–$200 per year depending on your credit profile. Quantum Surety offers instant quotes with no obligation." },
  { q: "How do I get a GDN bond in Round Rock?", a: "Apply online at Quantum Surety, receive instant approval, and get your $25,000 GDN bond certificate emailed the same day — ready to submit with your TxDMV dealer license application." },
