...
const faqs = [
  { q: "Do Plano auto dealers need a GDN bond?", a: "Yes. Every licensed motor vehicle dealer in Texas — including dealers in Plano / North Dallas — must carry a $50,000 GDN surety bond under Texas Transportation Code §503.033 before TxDMV will issue or renew a dealer license." },
  { q: "How much does a GDN bond cost for a Plano dealer?", a: "GDN dealer bonds through Quantum Surety start at $250 for the full 2-year term, which is RLI's minimum premium. RLI prices each bond, and your exact premium is confirmed before you pay." },
  { q: "How fast can I get a GDN bond in Plano?", a: "Same-day. Apply online, get approved, and receive your bond certificate as an instant PDF — ready to submit to TxDMV's eLICENSING portal the same day." },
  { q: "Does a Plano dealer need a city bond in addition to the GDN bond?", a: "The GDN bond is a state-level TxDMV requirement. Some municipalities may have additional local business license requirements, but the $50,000 GDN bond is the primary surety requirement for your dealer license." },
...
export default function GDNBondPlano() {
  useSEO({
    title: "GDN Bond Plano TX | Texas Motor Vehicle Dealer Bond | Quantum Surety",
    description: "Get your Texas GDN dealer bond in Plano same-day. Required under §503.033 for all Plano / North Dallas motor vehicle dealer licenses. $50,000 bond from $250 for the 2-year term. Instant PDF delivery.",
    canonical: "/bonds/gdn-bond-plano",
  });
  ...
  return (
    <div className="min-h-screen bg-white">
      <section className="bg-gradient-to-br from-indigo-900 via-indigo-800 to-teal-700 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-2 text-indigo-300 text-sm mb-4 flex-wrap">
            ...
            <ChevronRight className="w-4 h-4" /><span>Plano</span>
          </div>
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4 leading-tight">GDN Bond — Plano / North Dallas Motor Vehicle Dealers</h1>
          <p className="text-indigo-100 text-lg leading-relaxed mb-8 max-w-2xl">
            Plano / North Dallas motor vehicle dealers need a $50,000 GDN surety bond before TxDMV will issue or renew a dealer license. Get bonded same-day — instant PDF certificate, accepted by TxDMV eLICENSING.
          </p>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-14">
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Plano Dealer License Types That Require a GDN Bond</h2>
          <p className="text-gray-600 text-sm mb-6">All six TxDMV dealer license categories require a $50,000 GDN bond — whether your lot is in Plano, Allen, Frisco, McKinney, or anywhere in Collin County.</p>
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Frequently Asked Questions — Plano GDN Bond</h2>
      ...
      <div className="max-w-4xl mx-auto px-4 pb-16">
        <div className="bg-indigo-900 rounded-2xl p-8 text-white text-center">
          <h2 className="text-2xl font-bold mb-2">Get Your Plano GDN Bond Today</h2>
        ...
        <div className="mt-10">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              { href: "/bonds/gdn-bond-dallas", title: "GDN Bond — Dallas", tag: "Dallas" },
              { href: "/bonds/gdn-bond-austin", title: "GDN Bond — Austin", tag: "Austin" },
              { href: "/bonds/gdn-bond-texas", title: "Texas GDN Bond Overview", tag: "Statewide" },
            ].map((item) => (
