...
export default function VerifyContractor() {
  useSEO({
    ...
    description:
      "Free instant lookup: check any Texas TDLR-licensed contractor's license status before you hire. Search by name or license number. Powered by public TDLR data.",
    ...
    <div className="min-h-screen bg-white">
      <section className="bg-gradient-to-br from-gray-900 via-indigo-950 to-indigo-900 text-white py-16 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-indigo-200 text-lg mb-8">
            Check that your contractor holds an active TDLR license for the work before it begins.
          </p>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        {!loading && searched && results !== null && results.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mb-6 text-sm">
              Try a shorter search term or check for spelling. Licenses are issued by TDLR at tdlr.texas.gov.
            </p>
        ...
        {!loading && results && results.length > 0 && (
          <div>
              ...
              {results.map((c) => (
                <div key={c.license_number} className="border border-gray-200 rounded-xl p-5 hover:shadow-md transition-shadow">
                  ...
                  <div className="text-sm text-gray-600 flex flex-wrap gap-x-6 gap-y-1 mb-3">
                    ...
                    <span><strong>License expires:</strong> {c.expire_date ? new Date(c.expire_date).toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" }) : "—"}</span>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 mb-6 text-sm text-gray-600">
              ...
              TDLR requires licensed contractors to carry liability insurance, not a surety bond. Ask for a current certificate of insurance before work starts.{" "}
              <Link href="/get-bond?type=contractor">
                <span className="text-indigo-600 font-medium hover:underline cursor-pointer">Need a bond a city or project requires? →</span>
              </Link>
            </div>
          </div>
        )}
        ...
        <div className="mt-12 border-t border-gray-100 pt-10">
          <h2 className="text-xl font-bold text-gray-900 mb-6">What to check before you hire</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                icon: "🔒",
                title: "Insurance",
                desc: "TDLR requires licensed contractors to carry liability insurance. Ask for a current certificate of insurance before work starts.",
              },
              {
                icon: "📋",
                title: "License verification",
                desc: "Check that the license is active and that its type matches the work, for example an electrical contractor license for electrical work.",
              },
              {
                icon: "⚠️",
                title: "Red flags to watch for",
                desc: "A contractor who can't provide a TDLR license number, whose license has expired, or who asks for full payment upfront should give you pause. Verify before you sign any contract.",
              },
            ].map((item) => (
        ...
        <div className="mt-10 bg-indigo-900 text-white rounded-2xl p-6 text-center">
          ...
          <p className="text-indigo-300 text-sm mb-4">
            TDLR licenses require insurance, not a bond. If a city or a project owner asks you for a bond, we can write it, from $100.
          </p>
          <Link href="/get-bond?type=contractor">
            <Button variant="secondary">Request a Bond Quote</Button>
          </Link>
        </div>
      </div>
    </div>
