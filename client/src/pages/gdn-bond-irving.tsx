...
export default function GDNBondIrving() {
  useSEO({
    ...
    description: "Get your Texas GDN dealer bond in Irving same-day. Required under 503.033 for all motor vehicle dealer licenses. $50,000 bond from $250 for the 2-year term. Instant PDF delivery.",
