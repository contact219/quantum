/**
 * client/src/components/admin/Bmc84AdminPanel.tsx
 * ================================================
 * Drop into your existing admin page. Shows the BMC-84 pipeline,
 * filing SLA status, renewal queue, and revenue metrics.
 *
 * Usage in admin.tsx:
 *   import { Bmc84AdminPanel } from "@/components/admin/Bmc84AdminPanel";
 *   // Add as a new tab in your admin dashboard:
 *   <Bmc84AdminPanel />
 */
...
export function Bmc84AdminPanel() {
  ...
  const { data: bonds = [], isLoading } = useQuery<Bmc84Bond[]>({
    ...
    refetchInterval: 60_000, // refresh every minute to catch SLA breaches
  });
  ...
  // Bonds that need action (paid but not yet filed, or SLA breached)
