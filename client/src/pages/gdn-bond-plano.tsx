...
const faqs = [
  ...
  { q: "How much does a GDN bond cost for a Plano dealer?", a: "Most Plano dealers pay $100–$300 per year. Your exact rate is based on your personal credit score. Dealers with good credit (720+) typically pay around $100–$150/year for $50,000 in coverage." },
...
export default function GDNBondPlano() {
  useSEO({
    ...
    description: "Get your Texas GDN dealer bond in Plano same-day. Required under §503.033 for all Plano / North Dallas motor vehicle dealer licenses. $50,000 bond from $100/yr. Instant PDF delivery.",
