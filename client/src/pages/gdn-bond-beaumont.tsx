...
const SERVICE_SCHEMA = {
  ...
  "@type": "Service",
  "name": "Texas GDN Dealer Bond — Beaumont",
  "serviceType": "Surety Bond",
  "url": "https://quantumsurety.bond/bonds/gdn-bond-beaumont",
...
const FAQ_SCHEMA = {
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "Do auto dealers in Beaumont need a GDN bond?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Texas law requires all licensed motor vehicle dealers to obtain a $50,000 GDN surety bond through TxDMV as a condition of receiving or renewing a General Distinguishing Number (GDN) license." } },
    { "@type": "Question", "name": "How much does a GDN bond cost in Beaumont?", "acceptedAnswer": { "@type": "Answer", "text": "GDN dealer bonds through Quantum Surety start at $250 for the full 2-year term, which is RLI's minimum premium. Your exact premium is confirmed before you pay, with no obligation." } },
    { "@type": "Question", "name": "How do I get a GDN bond in Beaumont?", "acceptedAnswer": { "@type": "Answer", "text": "Apply online at Quantum Surety, receive instant approval, and get your $50,000 GDN bond certificate emailed the same day — ready to submit with your TxDMV dealer license application." } },
...
const faqs = [
  { q: "Do auto dealers in Beaumont need a GDN bond?", a: "Yes. Texas law requires all licensed motor vehicle dealers to obtain a $50,000 GDN surety bond through TxDMV as a condition of receiving or renewing a General Distinguishing Number (GDN) license." },
  { q: "How much does a GDN bond cost in Beaumont?", a: "GDN dealer bonds through Quantum Surety start at $250 for the full 2-year term, which is RLI's minimum premium. Your exact premium is confirmed before you pay, with no obligation." },
  { q: "How do I get a GDN bond in Beaumont?", a: "Apply online at Quantum Surety, receive instant approval, and get your $50,000 GDN bond certificate emailed the same day — ready to submit with your TxDMV dealer license application." },
    ...
    <div className="min-h-screen bg-white">
      <section className="bg-gradient-to-br from-indigo-900 via-indigo-800 to-teal-700 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4 leading-tight">Texas GDN Dealer Bond — Beaumont</h1>
          <p className="text-indigo-100 text-lg leading-relaxed mb-8 max-w-2xl">
            Texas GDN dealer bond for Beaumont auto dealers — required by TxDMV for your General Distinguishing Number license. Instant approval, same-day certificate.
          </p>
