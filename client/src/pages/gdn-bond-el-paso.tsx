...
export default function GDNBondElPaso() {
  useSEO({
    ...
    description: "Get your Texas GDN dealer bond in El Paso same-day. Required under §503.033 for all El Paso motor vehicle dealer licenses. $50,000 bond from $250 for the 2-year term. Instant PDF delivery.",
