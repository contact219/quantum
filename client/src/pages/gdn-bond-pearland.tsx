...
const SERVICE_SCHEMA = {
  ...
  "@type": "Service",
  "name": "Texas GDN Dealer Bond — Pearland",
...
const FAQ_SCHEMA = {
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "Do auto dealers in Pearland need a GDN bond?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Texas law requires all licensed motor vehicle dealers to obtain a $25,000 GDN surety bond through TxDMV as a condition of receiving or renewing a General Distinguishing Number (GDN) license." } },
    { "@type": "Question", "name": "How much does a GDN bond cost in Pearland?", "acceptedAnswer": { "@type": "Answer", "text": "GDN dealer bond premiums start from around $100–$200 per year depending on your credit profile. Quantum Surety offers instant quotes with no obligation." } },
    { "@type": "Question", "name": "How do I get a GDN bond in Pearland?", "acceptedAnswer": { "@type": "Answer", "text": "Apply online at Quantum Surety, receive instant approval, and get your $25,000 GDN bond certificate emailed the same day — ready to submit with your TxDMV dealer license application." } },
...
const faqs = [
  { q: "Do auto dealers in Pearland need a GDN bond?", a: "Yes. Texas law requires all licensed motor vehicle dealers to obtain a $25,000 GDN surety bond through TxDMV as a condition of receiving or renewing a General Distinguishing Number (GDN) license." },
  { q: "How much does a GDN bond cost in Pearland?", a: "GDN dealer bond premiums start from around $100–$200 per year depending on your credit profile. Quantum Surety offers instant quotes with no obligation." },
  { q: "How do I get a GDN bond in Pearland?", a: "Apply online at Quantum Surety, receive instant approval, and get your $25,000 GDN bond certificate emailed the same day — ready to submit with your TxDMV dealer license application." },
...
export default function GDNBondPearland() {
  useSEO({
    title: "Texas GDN Dealer Bond — Pearland | From $100 | Texas Surety Bond | Quantum Surety",
    description: "Texas GDN dealer bond for Pearland auto dealers — required by TxDMV for your General Distinguishing Number license. Instant approval, same-day certificate.",
